...
<c:choose>
  <c:when test="${pageName == 'showTextFile'}">
    <c:choose>
      ...
      <c:otherwise>
        ...
        <input type="button" class="btn" value="<spring:message code="diffprev.button.text"/>" onmouseover="Tip('<spring:message code="diffprev.button.tooltip" arguments="${command.path},${command.revision}"/>')" onclick="parent.location='<sventon-ui:formatUrl url="${diffPreviousUrl}"/>';">
      </c:otherwise>
    </c:choose>
  ...
  <c:when test="${pageName == 'showDiff' || pageName == 'showUnifiedDiff' || pageName == 'showInlineDiff'}">
    ...
    <input type="button" class="btn" value="<spring:message code="diffprev.button.text"/>" onmouseover="Tip('<spring:message code="diffprev.button.tooltip" arguments="${diffCommand.fromPath},${diffCommand.fromRevision}"/>')" onclick="parent.location='<sventon-ui:formatUrl url="${diffPreviousUrl}"/>';">
