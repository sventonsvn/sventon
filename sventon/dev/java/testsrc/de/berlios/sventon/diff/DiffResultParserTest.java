...
public class DiffResultParserTest extends TestCase {
  ...
  public void testDiffHelperDelete() throws Exception {
    ...
    assertSame(DiffAction.d, action.getAction());
    ...
    assertEquals("DiffSegment: d, left: 2-3, right: 2-2", action.toString());
  }
  ...
  public void testDiffHelperDeleteII() throws Exception {
    ...
    assertEquals("DiffSegment: d, left: 10-10, right: 10-10", action.toString());
  }
  ...
  public void testDiffHelperAdd() throws Exception {
    ...
    assertEquals("DiffSegment: a, left: 9-9, right: 10-11", action.toString());
  }
  ...
  public void testDiffHelperAddAndChange() throws Exception {
    ...
    assertEquals("DiffSegment: a, left: 8-8, right: 8-9", action.toString());
  }
