...
*/
    ...
    for (SourceLine[] tempStr : diffCreator.getSourceLines()) {
      sb.append(tempStr[0].getAction().getCode());
      sb.append(tempStr[0].getLine());
      sb.append("\n");
    }
    ...
    for (SourceLine[] tempStr : diffCreator.getSourceLines()) {
      sb.append(tempStr[1].getAction().getCode());
      sb.append(tempStr[1].getLine());
      sb.append("\n");
    }
