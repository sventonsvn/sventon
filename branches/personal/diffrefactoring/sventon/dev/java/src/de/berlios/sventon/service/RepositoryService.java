...
public interface RepositoryService {
   ...
   * @throws SVNException
   */
  List<SVNFileRevision> getFileRevisions(final SVNRepository repository, final String path, final long revision)
      throws SVNException;
  ...
  /**
   * Does a diff between two entries.
   *
   * @param repository    The repository instance.
   * @param diffCommand   The <code>DiffCommand</code> including to/from diff instructions.
   * @param configuration Instance configuration.
   * @return A list of a two dimensional matrix containing sourceLines for left (at position 0) and right (position 1).
   * @throws DiffException if unable to produce diff.
   * @throws SVNException  if a subversion error occurs.
   */
  List<SourceLine[]> diff(final SVNRepository repository, final DiffCommand diffCommand,
                          final InstanceConfiguration configuration) throws SVNException, DiffException;

  /**
   * Does a unified diff between two entries.
   *
   * @param repository    The repository instance.
   * @param diffCommand   The <code>DiffCommand</code> including to/from diff instructions.
   * @param configuration Instance configuration.
   * @return The unified diff result.
   * @throws DiffException if unable to produce diff.
   * @throws SVNException  if a subversion error occurs.
   */
  String diffUnified(final SVNRepository repository, final DiffCommand diffCommand,
                     final InstanceConfiguration configuration) throws SVNException, DiffException;
