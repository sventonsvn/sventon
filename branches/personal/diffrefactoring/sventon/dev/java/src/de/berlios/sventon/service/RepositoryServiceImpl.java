...
public class RepositoryServiceImpl implements RepositoryService {
   ...
   * {@inheritDoc}
   */
  public List<SourceLine[]> diff(final SVNRepository repository, final DiffCommand diffCommand,
    ...
    getFile(repository, diffCommand.getFromPath(), diffCommand.getFromRevision().getNumber(),
        outStream);
    ...
    getFile(repository, diffCommand.getToPath(), diffCommand.getToRevision().getNumber(),
        outStream);
    ...
    try {
      return new DiffCreator(leftFile, fromFileKeywordHandler, rightFile, toFileKeywordHandler).getSourceLines();
   ...
   * {@inheritDoc}
   */
  public String diffUnified(final SVNRepository repository, final DiffCommand diffCommand,
                            final InstanceConfiguration configuration) throws SVNException, DiffException {
    final RawTextFile leftFile =
        getTextFile(repository, diffCommand.getFromPath(), diffCommand.getFromRevision().getNumber());

    final RawTextFile rightFile =
        getTextFile(repository, diffCommand.getToPath(), diffCommand.getToRevision().getNumber());
