...
<head>
  ...
  function toggleAccessControl() {
    ...
    if (accessControl.checked) {
       ['global-uid', 'global-pwd', 'caching'].each(Element.hide);
       ['connection-test-uid', 'connection-test-pwd'].each(Element.show);
    } else {
       ['global-uid', 'global-pwd', 'caching'].each(Element.show);
       ['connection-test-uid', 'connection-test-pwd'].each(Element.hide);
    }
  }
