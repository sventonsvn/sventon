...
<ul>
  ...
  <li>WebDAV (http/https), svnserve (svn/svn+ssh) and file repository browsing.</li>
  <li>Support for multiple repositories.</li>
  <li>View and download files for any given revision or date in time.</li>
  <li>Friendly URL:s for easy navigation.</li>
  ...
  <li>Support for multiple character encodings.</li>
